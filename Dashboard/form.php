...
<body>
    <div class="form">
        <form action="index.php" method="POST">
            ...
            <!-- Input for Sidebar Social Profiles -->
            <div class="input-container ic1">
                <input id="extra" class="input" type="text" placeholder="" name="portfolio" />
                <label for="portfolio" class="placeholder">Portfolio</label>
            </div>

            <div class="input-container ic1">
                <input id="extra" class="input" type="text" placeholder="" name="linkdien" />
                <label for="linkdien" class="placeholder">Linkdien</label>
            </div>

            <div class="input-container ic1">
                <input id="extra" class="input" type="text" placeholder="" name="github" />
                <label for="github" class="placeholder">Github</label>
            </div>
